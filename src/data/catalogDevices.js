...
export const AIRPODS_CATALOG = [
  { model: 'AirPods 3',     storages: [], colors: ['Blanc'] },
  { model: 'AirPods 4',     storages: [], colors: ['Blanc'] },
...
export const WATCH_CATALOG = [
  { model: 'Apple Watch SE 3',           storages: ['40mm', '44mm'], colors: ['Lumière stellaire', 'Minuit', 'Argent'] },
  { model: 'Apple Watch Series 11 42mm', storages: ['42mm'], colors: ['Noir', 'Argent', 'Or rose', 'Titane naturel', 'Titane or'] },
  { model: 'Apple Watch Series 11 46mm', storages: ['46mm'], colors: ['Noir', 'Argent', 'Or rose', 'Titane naturel', 'Titane or'] },
  { model: 'Apple Watch Ultra 3',        storages: ['49mm'], colors: ['Titane naturel', 'Titane noir'] },
]
